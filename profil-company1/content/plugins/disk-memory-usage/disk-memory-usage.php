...
add_dashboard_widget( 'disk_memory_overview', 'Disk & Memory Overview', 'disk_memory_overview', array('href'=>'?request&load=disk-memory-usage/data.php&plg=yes', 'data-type'=>'edit') );