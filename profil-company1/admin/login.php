...
<a href="./"><strong>&laquo; Ke halaman utama </strong></a>
<?php if( $login->check() && $login->level('admin') ):?>
<span class="right"><a href="./?admin"><strong>Ke admin dashboard &raquo;</strong></a></span>
<?php endif;?>
...
<div class="boxinput">
<input type="text" name="username"  id="username" class="input user" placeholder="Alamat email atau Username" spellcheck="false"/>
<input type="password" name="password" id="password" class="input passcode" placeholder="Kata sandi"/>
</div>
<div style="padding-top:8px;float: left; width:100px;">
<label for="remember">Remember Me</label>
<input name="remember" value="1" id="remember" type="checkbox" style="width:14px">
</div>
<input type="submit" name="login" value="Masuk" class="right"/> 
<div style="clear:both;"></div>
</div>
</form>
<?php endif;?>
...
<label for="term">Saya setuju <strong><a href="?login&go=tos">peraturan</a></strong> ini?</label>
...
$r  = $db->fetch_array($q);
?>
<style type="text/css">#wrap{ width:565px; }</style>
<?php
...
?>
<div id="login_box">
<div id="login_head">Profil Saya</div>
...
<input type="file" name="thumb" style="width:160px"/>
</div>
...
<div style="clear:both"></div>
<div style="margin-top:20px; background:#f8f8f8; border:1px solid #ddd; padding:10px; padding-left:5px; padding-right:5px; text-align:center">Saya seorang <strong><?php echo $r['user_level']?></strong></div>
...
<input type="text" name="username" class="input disable" value="<?php echo $r['user_login']?>" disabled/><br />
<label>Email</label><span class="required">*</span>
<input type="text" name="email" class="input" value="<?php echo $r['user_email']?>"/><br />
<label>Nama Panggilan</label><span class="required">*</span>
<input type="text" name="author"  class="input" value="<?php echo $r['user_author']?>"/><br />
...
<input type="text" name="province"  class="input" value="<?php echo $r['user_province']?>"/><br />
<label>Website</label><br />
<textarea name="website" class="input" style="height:50px;"><?php echo $r['user_url']?></textarea><br />
</div>
<div style="clear:both"></div>
...
<input type="password" name="old_pass" id="password" class="input"/><br/>
<label>Kata sandi baru</label>
<input type="password" name="new_pass" id="newpassword" class="input"/><br/>
<label>Ulangi kata sandi baru</label>
<input type="password" name="rep_pass" id="renewpassword" class="input"/><br/>
...
<form method="post" action="" id="form">
<label>Email</label>
<input type="text" name="email"  id="email" class="input" placeholder="Alamat email kamu"/><br />
...
<style type="text/css">#wrap{ width:565px; }</style>
<div id="login_box">
<div id="login_head">Petunjuk penggunaan</div>
