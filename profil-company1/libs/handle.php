...
{
	$bail = sprintf( "<div class=\"padding\"><div class=\"message padding\"><h1>Exception Occured</h1>
			...
			<p>Jika Anda tidak yakin dengan istilah tersebut Anda mungkin harus menghubungi pihak pengembang.</p></div></div>
...
function handler($error_type, $error_message, $error_file, $error_line)
{
	switch($error_type){
		...
		case E_STRICT:
			//debug
			//log_exception('DEBUG ' . $error_type, $error_message, $error_file, $error_line);
			break;
		case E_NOTICE:
		case E_USER_NOTICE:
			//info
