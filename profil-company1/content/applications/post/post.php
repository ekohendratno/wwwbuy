...
$data_archive 	= array();
$query_post		= $db->select('post', array('type' => 'post', 'approved' => 1, 'status' => 1), "ORDER BY date_post DESC LIMIT $ps,$bt");
...
echo '<h4 class="bg" style="border-top:1px solid #ddd;">Kategori berita</h4>';
echo '<ul>';
