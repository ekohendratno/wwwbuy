...
function the_favicon($return = false){
	$the_favicon = '<link rel="icon" href="'.site_url('/favicon.ico').'" type=\"image/x-icon">'."\n";
	$the_favicon.= '<link rel="shortcut icon" href="'.site_url('/favicon.ico').'" type="image/x-icon">'."\n";
