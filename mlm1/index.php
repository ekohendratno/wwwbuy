<?php
	...
	if(isset($_SESSION['level']) AND $_SESSION['level']!='administrator'){
		echo '<h2 class="bg rt">Member Menu</h2>';
		echo '<div class="box"><strong>Welcome '.$_SESSION['name'].'</strong>';	
		echo '<div class="border listmenu"><ul><li><a href="member.php" title="" />Manager</a></li>';	
		echo '<li><a href="logout.html" title="" />Logout</a></li></ul></div>';	
		echo '</div>';
	}
	modul(0);
