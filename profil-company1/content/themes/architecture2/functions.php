...
function architecture2_theme_option( $param = null, $args = '' ){	
	$defaults = array(
		'logo' 	=> get_template_directory_uri() .'/images/logo.png',
		'limit_slide' 	=> 5,
		'ads' 	=> array(
						content_url() .'/uploads/ads.jpg',
						content_url() .'/uploads/ads.jpg',
						content_url() .'/uploads/ads.jpg'
			)
	); 
	
	if( checked_option( 'architecture2_options' ) && empty($args) ){
		$args = get_option('architecture2_options');
...
add_action( 'widgets_init', 'ars2_widgets_init' );
