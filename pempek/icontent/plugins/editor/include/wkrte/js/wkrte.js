/*
 * Lightweight RTE - jQuery Plugin, version 1.2 modified by Web-kreation.com
...
function lwrte_color(){
	var self = this;
	var panel = self.create_panel('Set color for text', 355);
...
lwRTE.prototype.create_toolbar = function(controls) {
	var self = this;
	var tb = $("<div></div>").addClass('rte-toolbar').append($("<div></div>").addClass('rte-toolbar-wrap').append($("<ul></ul>")).append($("<div></div>").addClass('rte-toolbar-arrow'))).hide();
	var obj, li;	
