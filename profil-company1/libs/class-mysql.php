...
class mysql {
	...
	function check_database_version(){
		...
		if ( version_compare($this->mysql_version(), $version_mysql, '<') )
			return new Error('database_version', sprintf( '<div class=\"padding\"><div class="message padding"><strong>ERROR</strong>: System %1$s requires MySQL %2$s or higher</div></div>', $version_system, $version_mysql ));
	}
