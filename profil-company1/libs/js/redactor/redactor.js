...
(function($){
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			colors: Array(
'#ff0000','#ed1c24','#ffff00','#fff200','#00ff00','#00a651','#00ffff','#00aeef','#0000ff','#2e3192','#ff00ff','#ec008c','#ffffff','#f5f4f4',
'#ebebeb','#e1e1e1','#d7d7d7','#cccccc','#c2c2c2','#b7b7b7','#acacac','#a0a0a0','#959595','#898989','#7d7d7d','#707070','#626262','#555555',
'#464646','#363636','#262626','#111111','#000000','#f7977a','#f26c4f','#ed1c24','#9e0b0f','#790000','#f9ad81','#f68e55','#f26522','#a0410d',
'#7b2e00','#fdc68a','#fbaf5c','#a36209','#7b2e00','#fff79a','#fff467','#fff200','#aba000','#827b00','#c4df9b','#acd372','#8dc73f','#598527',
'#406618','#a2d39c','#7cc576','#39b54a','#1a7b30','#005e20','#82ca9d','#3bb878','#00a651','#007236','#005826','#7bcdc8','#1abbb4','#00a99d',
'#00746b','#005952','#6ecff6','#6ecff6','#00bff3','#00aeef','#0076a3','#0076a3','#7ea7d8','#438cca','#0072bc','#004b80','#003663','#8493ca',
'#5574b9','#0054a6','#003471','#002157','#8882be','#605ca8','#2e3192','#1b1464','#0d004c','#a187be','#855fa8','#92278f','#630460','#4b0049',
'#f49ac2','#f06ea9','#ed145b','#9e005d','#7b0046','#f6989d','#f26d7d','#ed145b','#9e0039','#7a0026','#c7b299','#998675','#736357','#534741',
'#37302d','#c69c6e','#a67c52','#8c6239','#754c24','#603913'),
	...
	Redactor.prototype = {
		...
		observeScroll: function()
		{
			...
			{
				this.fixed = false;
				this.$toolbar.css({width: 'auto'}); //position: 'relative', 
			}
		},
		...
		buildToolbar: function()
		{
			...
			$.each(RTOOLBAR[this.opts.toolbar], $.proxy(function(key,s)
			{
				...
				if (key == 'html') $(li).addClass('redactor_toolbar_right');
	...
	Construct.prototype = {
		...
		{	
			...
			{	
				...
				this.dropareabox = $('<div class="redactor_dropareabox"><div class="redactor_dropareabox_text">' + this.opts.text + '</div></div>');	
