...
$header_menu = '';
$header_menu.= '<a id="popup" data-type="edit" href="?request&apps=yes&load=post/setting.php" title="Pengaturan Post" class="button button3 black" style="margin-right:2px;">Pengaturan</a>';
...
?>
	...
	<tr class="isi" <?php echo $warna;?>>
	  ...
	  <td style="border-top:0;"><a id="popup" href="?request&apps=yes&load=post/message.php&comment_id=<?php echo $row_comment->comment_id?>" data-type="send" title="Send a message">Send to email</a> &bull; <?php echo  time_stamp($row_comment->time)?></td>
    </tr>
<?php
$checkbox_id++;
}
