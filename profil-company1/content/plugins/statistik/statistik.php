...
add_dashboard_widget( 'statistik_monitoring', 'Statistik Monitoring', 'statistik_monitoring', array('href'=>'?request&aksi=delete&load=statistik/data.php&plg=yes', 'data-type'=>'confirm') );